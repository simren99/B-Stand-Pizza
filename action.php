				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-body'>
									<img src='product_images/$pro_image' style='width:230px; height:250px;'/>
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/viola/connect1.html"/>
					                <input type="hidden" name="notify_url" value="http://localhost/viola/connect1.html">
									<input type="hidden" name="cancel_return" value="http://localhost/viola/cancel.php"/>
